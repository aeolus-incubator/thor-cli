...
describe AeolusCli::Formatting do
  ...
  context ".create_format" do
    ...
    before do
      formatting.stub(:require).with("aeolus_cli/formatting/human_format").and_return(true)
      formatting.stub(:const_get).with("HumanFormat").and_return(human_format_class)
    end
