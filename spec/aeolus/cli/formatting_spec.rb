...
describe Aeolus::Cli::Formatting do
  let(:formatting) { Aeolus::Cli::Formatting }
  ...
  context ".create_format" do
    ...
    before do
      formatting.should_receive(:require).with("aeolus/cli/formatting/human_format").and_return(true)
